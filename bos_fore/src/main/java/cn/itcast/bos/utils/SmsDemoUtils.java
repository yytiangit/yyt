...
public class SmsDemoUtils {
    ...
    static final String accessKeyId = "LTAI6DBv0mG8sek7";//
    static final String accessKeySecret = "ikgY2RQLpYkyHr1C8CR6hlF1n6MxgB";
    ...
    public static SendSmsResponse sendSms(String telephone,String number) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("yyt");// 云通信
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_133978914"); // SMS_1000000
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("18899715996");
        //可选-流水号
